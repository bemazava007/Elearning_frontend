...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[32px] border border-slate-100 bg-white text-slate-950 shadow-sm transition-all duration-500 hover:shadow-[0_30px_60px_rgba(34,197,94,0.1)] hover:border-green-100",
      className,
    )}
    {...props}
  />
